...
def check_moment_capacity(moment_dictionary, section_dictionary, core_reinforcement_ratio=0.01):
    '''
    Input : 
...
def deflection_check(deflection_dictionary, drift_limit):
    """
    ...
    deflection_dcr = max_deflection / building_height

    return deflection_dcr


def main():
    test_story_forces = {0: 0, 10: 100, 20: 200, 30: 300, 40: 400}

    shear_forces = calculate_shear_diagram(test_story_forces)
    ...
    print("Story forces: ", test_story_forces)
    print("Shear forces: ", shear_forces)
    print("Moments: ", moments)
    print("Shear force DCR: ", shear_force_dcr)
    print("Moment DCR: ", moment_dcr)
    print("Deflection: ", lateral_displacement)
    print("Deflection DCR: ", deflection_check(lateral_displacement, 0.02))
